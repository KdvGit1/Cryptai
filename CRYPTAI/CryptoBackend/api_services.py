...
# ---------------------------------------------------------
# WINDOWS EMOJI DÜZELTME KODU (BURASI ÇOK KRİTİK)
# C# ile konuşurken "charmap" hatası almamak için
# çıktı formatını zorla UTF-8 yapıyoruz.
# ---------------------------------------------------------
...
def api_scan_market(timeframe: str, exchange_name: str):
    ...
    try:
        ...
        # Hata detayını terminale de yazdıralım ki C# görsün
